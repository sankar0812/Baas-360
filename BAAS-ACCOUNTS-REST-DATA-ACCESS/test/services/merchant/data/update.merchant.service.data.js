 ...
 */
module.exports = class deleteMerchantServiceData {
     ...
     */
    UPDATE_MERCHANT_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.merchant.update.v1",
            config: {
                "ID": 7,
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Merchant has updated successfully"
        },
    }
    ...
    UPDATE_MERCHANT_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Merchant has been updated successfully"
        },
    }
