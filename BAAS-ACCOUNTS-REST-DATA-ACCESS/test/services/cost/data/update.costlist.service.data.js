 ...
 */
module.exports = class deleteCostListServiceData {
     ...
     */
    UPDATE_COSTLIST_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.costlist.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE costlists",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Cost List has updated successfully"
        },
    }
    ...
    UPDATE_COSTLIST_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Cost List has been updated successfully"
        },
    }
