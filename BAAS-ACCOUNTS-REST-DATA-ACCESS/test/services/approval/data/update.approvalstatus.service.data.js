 ...
 */
module.exports = class deleteApprovalStatusServiceData {
     ...
     */
    UPDATE_APPROVALSTATUS_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.approvalstatus.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE approvalstatuses",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Approval Status has updated successfully"
        },
    }
     ...
     */
    UPDATE_APPROVALSTATUS_TS001_TC002 = {
    ...
    UPDATE_APPROVALSTATUS_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Approval Status has been updated successfully"
        },
    }
