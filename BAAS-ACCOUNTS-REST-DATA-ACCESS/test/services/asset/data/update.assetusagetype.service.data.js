 ...
 */
module.exports = class deleteAssetUsageTypeServiceData {
     ...
     */
    UPDATE_ASSETUSAGETYPE_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.assetusagetype.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE assetusagetypes",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Asset Usage Type has updated successfully"
        },
    }
     ...
     */
    UPDATE_ASSETUSAGETYPE_TS001_TC002 = {
    ...
    UPDATE_ASSETUSAGETYPE_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Asset Usage Type has been updated successfully"
        },
    }
