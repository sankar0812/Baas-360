 ...
 */
module.exports = class deleteAssetClassServiceData {
     ...
     */
    UPDATE_ASSETCLASS_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.assetclass.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE assetclasses",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Asset Class has updated successfully"
        },
    }
    ...
    UPDATE_ASSETCLASS_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Asset Class has been updated successfully"
        },
    }
