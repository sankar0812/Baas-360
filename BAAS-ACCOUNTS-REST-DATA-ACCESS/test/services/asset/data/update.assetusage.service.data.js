 ...
 */
module.exports = class deleteAssetUsageServiceData {
     ...
     */
    UPDATE_ASSETUSAGE_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.assetusage.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE assetusages",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Asset Usage has updated successfully"
        },
    }
    ...
    UPDATE_ASSETUSAGE_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Asset Usage has been updated successfully"
        },
    }
