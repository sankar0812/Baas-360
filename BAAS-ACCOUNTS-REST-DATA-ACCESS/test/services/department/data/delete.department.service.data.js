 ...
 */
module.exports = class deleteDepartmentrServiceData{
	 ...
	 */
	DELETE_ONE_DEPARTMENT_TS001_TC001 = {

		description : "Test function's output structure is upto the specification",
		input : {
            databaseConnector : null,
            apiID : "accounts.api.rest.dataaccess.department.delete.v1",
            config : {
                "ID" : 1,
                "Name" : "UPDATED DEPARTMENT",
                "Endpoint" : "/api/rest/base/dataaccess/1.0.0/department/v1/department/:departmentid",
                "IsAvailable" : true,
                "IsMockEnabled" : true
            },
            input : null,
	 ...
	 */
	DELETE_ONE_DEPARTMENT_TS001_TC002 = {
	 ...
	 */
	DELETE_ONE_DEPARTMENT_TS001_TC003 = {
		...
		output: {
            data : {},
            status : 200,
            message : "[MOCK] Department has been deleted successfully"
        },
	}
