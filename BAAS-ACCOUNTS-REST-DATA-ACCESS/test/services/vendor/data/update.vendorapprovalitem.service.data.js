 ...
 */
module.exports = class deleteVendorApprovalItemServiceData {
     ...
     */
    UPDATE_VENDORAPPROVALITEM_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.vendorapprovalitem.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE vendorapprovalitems",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Vendor Approval Item has updated successfully"
        },
    }
     ...
     */
    UPDATE_VENDORAPPROVALITEM_TS001_TC002 = {
    ...
    UPDATE_VENDORAPPROVALITEM_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Vendor Approval Item has been updated successfully"
        },
    }
