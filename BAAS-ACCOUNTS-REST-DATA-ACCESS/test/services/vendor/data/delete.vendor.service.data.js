 ...
 */
module.exports = class deleteVendorrServiceData{
	 ...
	 */
	DELETE_ONE_VENDOR_TS001_TC001 = {

		description : "Test function's output structure is upto the specification",
		input : {
            databaseConnector : null,
            apiID : "accounts.api.rest.dataaccess.vendor.delete.v1",
            config : {
                "ID" : 1,
                "Name" : "UPDATED VENDOR",
                "Endpoint" : "/api/rest/base/dataaccess/1.0.0/vendor/v1/vendor/:vendorid",
                "IsAvailable" : true,
                "IsMockEnabled" : true
            },
            input : null,
	...
	DELETE_ONE_VENDOR_TS001_TC003 = {
		...
		output: {
            data : {},
            status : 200,
            message : "[MOCK] Vendor has been deleted successfully"
        },
	}
