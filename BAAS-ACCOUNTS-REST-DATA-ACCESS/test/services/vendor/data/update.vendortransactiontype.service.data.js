 ...
 */
module.exports = class deleteVendorTransactionTypeServiceData {
     ...
     */
    UPDATE_VENDORTRANSACTIONTYPE_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.vendortransactiontype.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE vendortransactiontypes",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Vendor Transaction Type has updated successfully"
        },
    }
     ...
     */
    UPDATE_VENDORTRANSACTIONTYPE_TS001_TC002 = {
    ...
    UPDATE_VENDORTRANSACTIONTYPE_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Vendor Transaction Type has been updated successfully"
        },
    }
