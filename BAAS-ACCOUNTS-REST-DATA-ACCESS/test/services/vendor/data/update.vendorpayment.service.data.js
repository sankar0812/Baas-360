 ...
 */
module.exports = class deleteVendorPaymentServiceData {
     ...
     */
    UPDATE_VENDORPAYMENT_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.vendorpayment.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE vendorpayments",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Vendor Payment has updated successfully"
        },
    }
     ...
     */
    UPDATE_VENDORPAYMENT_TS001_TC002 = {
    ...
    UPDATE_VENDORPAYMENT_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Vendor Payment has been updated successfully"
        },
    }
