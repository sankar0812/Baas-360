 ...
 */
module.exports = class deleteGroupUserServiceData {
     ...
     */
    UPDATE_GROUPUSER_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.groupuser.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE groupusers",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Group User has updated successfully"
        },
    }
    ...
    UPDATE_GROUPUSER_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Group User has been updated successfully"
        },
    }
