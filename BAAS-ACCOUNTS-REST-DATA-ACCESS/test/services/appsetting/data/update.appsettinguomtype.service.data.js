 ...
 */
module.exports = class deleteAppSettingUomTypeServiceData {
     ...
     */
    UPDATE_APPSETTINGUOMTYPE_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.appsettinguomtype.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE appsettinguomtypes",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] App Setting Uom Type has updated successfully"
        },
    }
     ...
     */
    UPDATE_APPSETTINGUOMTYPE_TS001_TC002 = {
    ...
    UPDATE_APPSETTINGUOMTYPE_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] App Setting Uom Type has been updated successfully"
        },
    }
