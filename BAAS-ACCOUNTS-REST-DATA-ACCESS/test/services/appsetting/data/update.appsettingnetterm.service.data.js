 ...
 */
module.exports = class deleteAppSettingNetTermServiceData {
     ...
     */
    UPDATE_APPSETTINGNETTERM_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.appsettingnetterm.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE appsettingnetterms",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] App Setting Net Term has updated successfully"
        },
    }
     ...
     */
    UPDATE_APPSETTINGNETTERM_TS001_TC002 = {
    ...
    UPDATE_APPSETTINGNETTERM_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] App Setting Net Term has been updated successfully"
        },
    }
