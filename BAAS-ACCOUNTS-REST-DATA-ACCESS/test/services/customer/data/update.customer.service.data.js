 ...
 */
module.exports = class deleteCustomerServiceData {
     ...
     */
    UPDATE_CUSTOMER_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.customer.update.v1",
            config: {
                "ID": 7,
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Customer has updated successfully"
        },
    }
    ...
    UPDATE_CUSTOMER_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Customer has been updated successfully"
        },
    }
