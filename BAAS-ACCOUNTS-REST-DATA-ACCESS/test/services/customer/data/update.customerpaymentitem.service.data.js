 ...
 */
module.exports = class deleteCustomerPaymentItemServiceData {
     ...
     */
    UPDATE_CUSTOMERPAYMENTITEM_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.customerpaymentitem.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE customerpaymentitems",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Customer Payment Item has updated successfully"
        },
    }
     ...
     */
    UPDATE_CUSTOMERPAYMENTITEM_TS001_TC002 = {
    ...
    UPDATE_CUSTOMERPAYMENTITEM_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Customer Payment Item has been updated successfully"
        },
    }
