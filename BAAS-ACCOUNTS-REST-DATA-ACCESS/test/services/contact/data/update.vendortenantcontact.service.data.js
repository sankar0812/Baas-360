 ...
 */
module.exports = class deleteVendorTenantContactServiceData {
     ...
     */
    UPDATE_VENDORTENANTCONTACT_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.vendortenantcontact.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE vendortenantcontacts",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Vendor Tenant Contact has updated successfully"
        },
    }
     ...
     */
    UPDATE_VENDORTENANTCONTACT_TS001_TC002 = {
    ...
    UPDATE_VENDORTENANTCONTACT_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Vendor Tenant Contact has been updated successfully"
        },
    }
