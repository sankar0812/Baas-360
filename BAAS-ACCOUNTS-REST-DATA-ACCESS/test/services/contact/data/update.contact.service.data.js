 ...
 */
module.exports = class deleteContactServiceData {
     ...
     */
    UPDATE_CONTACT_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.contact.update.v1",
            config: {
                "ID": 7,
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Contact has updated successfully"
        },
    }
    ...
    UPDATE_CONTACT_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Contact has been updated successfully"
        },
    }
