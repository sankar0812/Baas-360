 ...
 */
module.exports = class deleteInvoiceServiceData {
     ...
     */
    UPDATE_INVOICE_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.invoice.update.v1",
            config: {
                "ID": 7,
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Invoice has updated successfully"
        },
    }
    ...
    UPDATE_INVOICE_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Invoice has been updated successfully"
        },
    }
