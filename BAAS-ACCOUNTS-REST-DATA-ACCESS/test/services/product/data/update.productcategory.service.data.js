 ...
 */
module.exports = class deleteProductCategoryServiceData {
     ...
     */
    UPDATE_PRODUCTCATEGORY_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.productcategory.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE productcategorys",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Product Category has updated successfully"
        },
    }
     ...
     */
    UPDATE_PRODUCTCATEGORY_TS001_TC002 = {
    ...
    UPDATE_PRODUCTCATEGORY_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Product Category has been updated successfully"
        },
    }
