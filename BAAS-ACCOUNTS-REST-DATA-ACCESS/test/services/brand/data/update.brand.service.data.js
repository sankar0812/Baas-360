 ...
 */
module.exports = class deleteBrandServiceData {
     ...
     */
    UPDATE_BRAND_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.brand.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE brands",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Brand has updated successfully"
        },
    }
    ...
    UPDATE_BRAND_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Brand has been updated successfully"
        },
    }
