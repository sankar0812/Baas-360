 ...
 */
module.exports = class deleteProposalItemParamServiceData {
     ...
     */
    UPDATE_PROPOSALITEMPARAM_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.proposalitemparam.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE proposalitemparams",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Proposal Item Param has updated successfully"
        },
    }
     ...
     */
    UPDATE_PROPOSALITEMPARAM_TS001_TC002 = {
    ...
    UPDATE_PROPOSALITEMPARAM_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Proposal Item Param has been updated successfully"
        },
    }
