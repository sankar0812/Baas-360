 ...
 */
module.exports = class deletePriceListrServiceData{
	 ...
	 */
	DELETE_ONE_PRICELIST_TS001_TC001 = {

		description : "Test function's output structure is upto the specification",
		input : {
            databaseConnector : null,
            apiID : "accounts.api.rest.dataaccess.pricelist.delete.v1",
            config : {
                "ID" : 1,
                "Name" : "UPDATED PRICELIST",
                "Endpoint" : "/api/rest/base/dataaccess/1.0.0/pricelist/v1/pricelist/:pricelistid",
                "IsAvailable" : true,
                "IsMockEnabled" : true
            },
            input : null,
	 ...
	 */
	DELETE_ONE_PRICELIST_TS001_TC002 = {
	 ...
	 */
	DELETE_ONE_PRICELIST_TS001_TC003 = {
		...
		output: {
            data : {},
            status : 200,
            message : "[MOCK] Price List has been deleted successfully"
        },
	}
