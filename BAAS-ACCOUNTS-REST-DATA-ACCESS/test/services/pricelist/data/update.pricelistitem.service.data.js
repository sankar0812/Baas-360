 ...
 */
module.exports = class deletePriceListItemServiceData {
     ...
     */
    UPDATE_PRICELISTITEM_TS001_TC001 = {

        description: "Test function's output structure is upto the specification",
        input: {
            databaseConnector: null,
            apiID: "accounts.api.rest.dataaccess.pricelistitem.update.v1",
            config: {
                "ID": 7,
                "Name": "UPDATE pricelistitems",
        ...
        output: {
            data: null,
            status: 200,
            message: "[MOCK] Price List Item has updated successfully"
        },
    }
     ...
     */
    UPDATE_PRICELISTITEM_TS001_TC002 = {
    ...
    UPDATE_PRICELISTITEM_TS001_TC003 = {
        ...
        output: {
            data: {},
            status: 200,
            message: "[MOCK] Price List Item has been updated successfully"
        },
    }
